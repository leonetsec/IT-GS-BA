...
def main():
    ...
    parser.add_argument("--check-reqs", action="store_true", help="Prüft die Anforderungen von Richtlinien auf Vollständigkeit")
    ...
    if args.check_reqs:
        check_reqs(args.file_or_dir, args.typ)
        return
