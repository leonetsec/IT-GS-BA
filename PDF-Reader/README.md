# IT-Grundschutz PDF-Reader basierend auf PDF.js
...
## Nutzung
- npm start
- In beliebigem Browser http://localhost:8888/web/viewer.html öffnen
- Gewünschte PDF öffnen

## Funktionen
- Zum Inhaltsverzeichnis springen
- Referenzen automatisch erkennen (z.B. ISO, DIN, BSI-Standards)
- Nach regulären Ausdrücken (Regex) suchen
